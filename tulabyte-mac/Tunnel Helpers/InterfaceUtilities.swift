...
var directoryItems: [DirectoryItem] = [
    DirectoryItem(title: "TulaByte Mobile App", description: "Our flagship product, the app you are currently in.", url: URL(string: "https://tulabyte.web.app")!, madeByUs: true),
